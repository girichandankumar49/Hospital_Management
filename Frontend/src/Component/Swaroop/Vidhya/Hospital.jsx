...
const Hospital = () => {
    ...
    <div>
      ...
      <section className="hero">
        ...
        <div className="hero-left">
          <h1>Medicover Hospitals – Trusted Multispeciality Hospitals</h1>
  ...
  <div className="info-card">
    ...
    <p><b>What is it:</b> {specialtyData[selectedSpec]?.desc}</p>
    <p><b>Common Issues:</b> {specialtyData[selectedSpec]?.issues}</p>
  </div>
)}
            </div>
            ...
            {Object.keys(specialtyData).map((spec) => (
              ...
              >
                <div className="circle-img">
                  <img src="https://cdn-icons-png.flaticon.com/512/2966/2966489.png" alt="" />
                </div>
                <p>{spec}</p>
              </div>
            ))}
        ...
        <div className="hero-img">
          <img src="https://www.medicoverhospitals.in/images/bring01.webp" alt="" />
        </div>
      ...
      <div className="states">
        ...
        <div className="state-grid">
          <div className="state-card">
            <img src="https://www.mapsofindia.com/maps/telangana/telangana-map.jpg" alt="" />
            <div className="state-name">Telangana</div>
          </div>

          <div className="state-card">
            <img src="https://www.pikpng.com/pngl/m/209-2094688_andhra-pradesh-with-23-districts-tada-andhra-pradesh.png" alt="" />
            <div className="state-name">Andhra Pradesh</div>
          </div>

          <div className="state-card">
            <img src="https://www.mapsofindia.com/maps/maharashtra/maharashtra-map.jpg" alt="" />
            <div className="state-name">Maharashtra</div>
          </div>

          <div className="state-card">
            <img src="https://www.mapsofindia.com/maps/karnataka/karnataka-map.jpg" alt="" />
